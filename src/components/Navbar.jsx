...
const Navbar = () => {
  return (
    <header class="body-font text-gray-600 border-b-2 bg-gray-300">
      <div class="container mx-auto flex flex-col flex-wrap items-center p-5 md:flex-row">
        <a class="title-font mb-4 flex items-center font-medium text-gray-900 md:mb-0">
          <svg
            class="h-10 w-10 rounded-full bg-gray-200 p-2"
            fill="none"
            stroke="currentColor"
          ...
          <span class="ml-3 text-xl">Peer.io</span>
        </a>
        ...
        <button class="mt-4 inline-flex items-center rounded border-0 bg-gray-100 px-3 py-1 text-base hover:bg-gray-200 focus:outline-none md:mt-0">
          Button
          <svg
            fill="none"
            stroke="currentColor"
